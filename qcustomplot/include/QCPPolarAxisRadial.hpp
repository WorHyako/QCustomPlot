#ifndef QCUSTOMPLOT_QCPPOLARAXISRADIAL_HPP
#define QCUSTOMPLOT_QCPPOLARAXISRADIAL_HPP
...
Q_DECLARE_METATYPE(QCP::QCPPolarAxisRadial::AngleReference)

Q_DECLARE_METATYPE(QCP::QCPPolarAxisRadial::ScaleType)

Q_DECLARE_METATYPE(QCP::QCPPolarAxisRadial::SelectablePart)
