#ifndef QCUSTOMPLOT_QCUSOMPLOT_HPP
#define QCUSTOMPLOT_QCUSOMPLOT_HPP

#include "defs.hpp"
#include "enums.hpp"
#include "QCPLayoutGrid.hpp"
#include "QCPSelectionRect.hpp"
#include "QCPGraph.hpp"
...
namespace QCP {
    ...
    public:
      ...
      */
        ...
        AntialiasedElements antialiasedElements() const { return mAntialiasedElements; }

        AntialiasedElements notAntialiasedElements() const { return mNotAntialiasedElements; }
        ...
        PlottingHints plottingHints() const { return mPlottingHints; }

        Qt::KeyboardModifier multiSelectModifier() const { return mMultiSelectModifier; }

        SelectionRectMode selectionRectMode() const { return mSelectionRectMode; }
        ...
        plottableAt(const QPointF &pos, bool onlySelectable = false, int *dataIndex = nullptr) const;
        ...
        bool
        savePdf(const QString &fileName, int width = 0, int height = 0, ExportPen exportPen = QCP::epAllowCosmetic,
                const QString &pdfCreator = QString(), const QString &pdfTitle = QString());

        bool savePng(const QString &fileName, int width = 0, int height = 0, double scale = 1.0, int quality = -1,
                     int resolution = 96, ResolutionUnit resolutionUnit = QCP::ruDotsPerInch);

        bool saveJpg(const QString &fileName, int width = 0, int height = 0, double scale = 1.0, int quality = -1,
                     int resolution = 96, ResolutionUnit resolutionUnit = QCP::ruDotsPerInch);

        bool saveBmp(const QString &fileName, int width = 0, int height = 0, double scale = 1.0, int resolution = 96,
                     ResolutionUnit resolutionUnit = QCP::ruDotsPerInch);
    ...
    protected:
        ...
        AntialiasedElements mAntialiasedElements, mNotAntialiasedElements;
        ...
        PlottingHints mPlottingHints;
        Qt::KeyboardModifier mMultiSelectModifier;
        SelectionRectMode mSelectionRectMode;
        ...
        AntialiasedElements mOpenGlAntialiasedElementsBackup;
